...
class AdminLookupWebsiteTypesController extends AdminLookupTableBaseController
{
     ...
     */
    public $table_type_plural   = "Website Types";

    /*
     * Lookup table type, in the singular
     */
    public $table_type_singular  = "Website Type";

    /*
     * Lookup table name
     */
    public $table_name           = "lookup_website_types";
     ...
     */
    public $model_class          = "Lookup_website_type";

    /*
     * The base URL of this lookup table's resource routes
     */
    public $resource_route_name   = "luwebsites";
