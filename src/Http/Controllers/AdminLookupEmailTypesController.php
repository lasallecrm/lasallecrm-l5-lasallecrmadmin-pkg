...
class AdminLookupEmailTypesController extends AdminLookupTableBaseController
{
     ...
     */
    public $table_type_plural   = "Email Types";

    /*
     * Lookup table type, in the singular
     */
    public $table_type_singular  = "Email Type";

    /*
     * Lookup table name
     */
    public $table_name           = "lookup_email_types";
     ...
     */
    public $model_class          = "Lookup_email_type";

    /*
     * The base URL of this lookup table's resource routes
     */
    public $resource_route_name   = "luemails";
