...
class AdminLookupEmailTypesController extends AdminLookupTableBaseController
{
     ...
     */
    protected $table_type_plural   = "Email Types";

    /*
     * Lookup table type, in the singular
     */
    protected $table_type_singular  = "Email Type";

    /*
     * Lookup table name
     */
    protected $table_name           = "lookup_email_types";
     ...
     */
    protected $model_class          = "Lookup_email_type";

    /*
     * The base URL of this lookup table's resource routes
     */
    protected $resource_route_name   = "luemails";
