 ...
 */
class LasallecrmadminServiceProvider extends ServiceProvider {
    ...
    {
        $configuration = realpath(__DIR__.'/../config/lasallecrmadmin.php');

        $this->publishes([
            $configuration => config_path('lasallecrmadmin.php'),
        ]);
    }
     ...
     * @return void
     */
    private function registerLasallecrmadmin()
    {
        $this->app->bind('lasallecrmadmin', function($app) {
            return new Lasallecrmadmin($app);
        });
